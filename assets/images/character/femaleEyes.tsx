...
const FemaleEyes = ({ eyeColor, style }: EyesProps, props: SvgProps) => {
  return (
    <Svg
      width={85}
      height={33}
      ...
      style={tw`${style || ""}`}
    >
      <Path fill="#000" d="M17 12H6v-2h11v2Z" />
      <Rect
        width={22}
        height={31}
        x={17}
        ...
        rx={11}
      />
      <Path fill="#000" d="M68 12h10v-2H68v2Z" />
      <Rect
        width={22}
        height={31}
        x={-1}
      ...
      <Rect width={7} height={15} x={29} y={9} fill="#674238" rx={3} />
      <Circle cx={30.5} cy={10.5} r={2.5} fill="#fff" />
      <Rect width={20} height={28.75} x={47} y={2} fill="#fff" rx={10} />
      <Rect width={7} height={15} x={58} y={9} fill="#674238" rx={3} />
